...
~
	\smartdiagram[bubble diagram]{
        \textbf{Science}\\\textbf{~~~~~~~~des~~~~~~~~}\\\textbf{données},
        \textbf{~~~~~~~Fouille~~~~~~~}\\\textbf{de données},
        \textbf{~~Sciences~~}\\\textbf{cognitives},
        \textbf{~Statistiques~},
        \textbf{Apprentissage}\\\textbf{profond},
        \textbf{Philosophie}\\\textbf{des sciences}
    }
}
...
\begin{itemize}
    ...
    \item Outils : nginx, \textbf{git}, Docker, Vim, Jenkins
    \item Frameworks : SFML, Qt, Django, \textbf{PyTorch}, \textbf{Tensorflow}
\end{itemize}
}
\personalskills{
\begin{itemize}
...
\begin{itemize}
    ...
    \item \includegraphics[scale=0.1]{img/japanese_flag.png} Japonais (débutant, A1)
\end{itemize}
}
...
\cvjobtitle{Doctorant\\\small{Éthique de l'intelligence artificielle}} % Job
% title/career

\cvgithub{gjorando}
%\cvnumberphone{(+33)6 71 81 28 13} % French Phone number
%\cvnumberphone{(+1) 581-980-1042} % Canadian Phone number
\cvnumberphone{} % No phone number
\cvsite{portfolio.intensifi.es} % Personal website
%\cvlinkedin{guillaume-jorandon-b088a5116}
\cvlinkedin{}
\cvmail{guillaume.jorandon.1@ulaval.ca} % Email address
