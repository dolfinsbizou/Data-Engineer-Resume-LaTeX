...
~
	\smartdiagram[bubble diagram]{
        ...
        \textbf{Développement}\\\textbf{logiciel},
        \textbf{~~~~~~Maths~~~~~~},
...
% Skills
\programming{{Bash $\textbullet$ R $\textbullet$ JS / 3.5}, {Java $\textbullet$ PHP $\textbullet$ Python / 5}, {C $\textbullet$ C++  $\textbullet$ Python / 6}} 
\computerskills{
\begin{itemize}
